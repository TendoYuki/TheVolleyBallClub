...
class AccountController {
    ...
    public static function checkEmailUnicity($email) {
        ...
        $stmt = AccountController::$connection->getConnection()->prepare(
    ...
    public static function has($string,$list){
        foreach(str_split($list) as $symbol) if(str_contains($symbol,$string))return true;
        return false;
    }
    ...
    public static function checkAvatarSize(int $avatar_size) {
        throw new InvalidAvatarSizeException();
    }
